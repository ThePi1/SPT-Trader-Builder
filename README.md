...
Alternatively, manually, you can pack as follows:
    ...
    pyinstaller .\quest-builder.py --onefile --icon=data/icon.ico --hide-console=hide-early
    > Go into dist/ folder and grab quest_builder.exe
    > Copy quest_builder.exe, LICENSE, and data/ folder to new folder.
    > Zip up and release
