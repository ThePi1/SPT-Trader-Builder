...
class Controller:
  ...
  try:
    ...
    tb_elim_locale_box                    = str(parser.get('box_fields', 'tb_elim_locale_box'))
    tb_handover_locale_box                = str(parser.get('box_fields', 'tb_handover_locale_box'))
    tb_visitzone_locale_box               = str(parser.get('box_fields', 'tb_visitzone_locale_box'))
    tb_leaveitem_locale_box               = str(parser.get('box_fields', 'tb_leaveitem_locale_box'))
    qb_locale_box                         = str(parser.get('box_fields', 'qb_locale_box'))
    ...
    tb_traderloyalty_locale_box           = str(parser.get('box_fields', 'tb_traderloyalty_locale_box'))
    tb_exitstatus_locale_box              = str(parser.get('box_fields', 'tb_exitstatus_locale_box'))
    ...
    tb_skillreq_locale_box                = str(parser.get('box_fields', 'tb_skillreq_locale_box'))
    tb_skillreq_compare_box               = str(parser.get('box_fields', 'tb_skillreq_compare_box')).split(',')
    tb_skillreq_target_box                = str(parser.get('box_fields', 'tb_skillreq_target_box')).split(',')
