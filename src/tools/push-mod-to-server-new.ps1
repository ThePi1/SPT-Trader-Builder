...
$local_data_path = "I:\Games\rtt2\Development\rtt2-traders2"
$server_data_path = "\\192.168.1.42\Share\rtt2\SPT\user\mods\rtt2"
Remove-Item ($server_data_path + "\*") -Recurse

# Copy latest mod dll from output folder to server
$local_mod_path = "I:\Games\rtt2\SPT\user\mods\rtt2"
$server_mod_path = "\\192.168.1.42\Share\rtt2\SPT\user\mods\rtt2"
