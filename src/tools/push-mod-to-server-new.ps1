...
$server_data_path = "\\192.168.1.42\Share\rtt2-beta-4-0-13\SPT\user\mods\rtt2-traders"
Remove-Item ($server_data_path + "\*") -Recurse

# Copy latest mod dll from output folder to server
$local_mod_path = "I:\Games\rtt2-beta-4-0-13\BepInEx\plugins"
$server_mod_path = "\\192.168.1.42\Share\rtt2-beta-4-0-13\SPT\user\mods\rtt2-traders"
