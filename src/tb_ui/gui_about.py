...
class Ui_AboutMenu(object):
	...
	def retranslateUi(self, AboutMenu):
		...
		self.label.setText(
			_translate(
				"AboutMenu",
				'<html><head/><body><p>Made with ♥ by the SPT Trader Builder Team</p><p>V_CUR</p><p><a href="SRC_URL"><span style=" text-decoration: underline; color:#0000ff;">SRC_URL</span></a></p></body></html>',
			)
		)
